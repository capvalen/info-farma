...
if($_POST['tipo']=='suma'){ $filtro = " and s.idMovimiento in (". implode( ',',$suma) .")"; }
if($_POST['tipo']=='resta'){ $filtro = " and s.idMovimiento in (". implode( ',',$resta) .")"; }
...
where idProducto = {$_POST['idProducto']} and stoActivo =1 {$filtro} 
...
while($row=$resultado->fetch_assoc()){
	...
	<tr>
		...
		<td><?= $row['stoFecha']; ?></td>
		<td class="mayuscula"><?= $row['usuNombre']; ?></td>
