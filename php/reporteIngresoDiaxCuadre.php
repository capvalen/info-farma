...
if($totalVentas>=1){
	while($rowVentas=$resultadoVentas->fetch_assoc()){ 
		if($_COOKIE['ckPower']==1 ): $boton = "<button class='btn btn-sm btn-negro btn-outline' onclick='editarCajaMaestra(".$rowVentas['idVenta'].")'><i class='icofont icofont-edit'></i></button>"; else: $boton=''; endif;
