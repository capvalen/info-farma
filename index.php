	...
	<div class="container-fluid">				 
			<div class="row">
				...
				<!-- Empieza a meter contenido principal dentro de estas etiquetas -->
				 <h2 class="blue-text text-darken-1"><i class="icofont icofont-animal-cat-alt-4"></i> Bienvenido: <small>Software Info-Farma v1.1.2b</small> <small class="blue-text text-lighten-3">2017-116</small></h2>
