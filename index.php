			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-3">
					<div class="thumbnail">
					 <!-- <img src="images/cara.jpg" alt="...">-->
						<div class="caption">
							<p class="text-center"><a href="productos.html" class="btn btn-success btn-outline btn-circle-grande	" role="button"><i class="icofont icofont-herbal"></i></a> </p>
				...
				<div class="col-sm-6 col-md-3">
					...
					<div class="thumbnail">
						<!-- <img src="images/cara.jpg" alt="...">-->
						<div class="caption">
							<p class="text-center"><a href="inventario.php#invRegist" class="btn btn-indigo btn-outline btn-circle-grande" role="button"><i class="icofont icofont-list"></i></a> </p>
							<h3 class="text-center">Listar inventario</h3>
				...
				<div class="col-sm-6 col-md-3">
					<div class="thumbnail">
						<!-- <img src="images/cara.jpg" alt="...">-->
						<div class="caption">
							<p class="text-center"><a href="reportes.php" class="btn btn-morita btn-outline btn-circle-grande	" role="button"><i class="icofont icofont-files"></i></a> </p>
				...
				<div class="col-sm-6 col-md-3">
					<div class="thumbnail">
						<!-- <img src="images/cara.jpg" alt="...">-->
						<div class="caption">
							<p class="text-center"><a href="reportes.php" class="btn btn-danger btn-outline btn-circle-grande	" role="button"><i class="icofont icofont-paw"></i></a> </p>
